...
{
    public class SeaTruckDrillArmControl : MonoBehaviour, ISeaTruckArm
    {
        ...
        private void Awake()
        {
            ...
            fxSpawnPoint = manager.objectHelper.FindDeepChild(gameObject, "FXSpawnPoint").transform;
        ...
        public void OnHit()
        {
...
#endif
            {
                ...
                UWE.Utils.TraceFPSTargetPosition(helper.MainCab, attackDist, ref hitObject, ref pos, out Vector3 normal, true);
                ...
                if (hitObject && drilling)
                {
                    ...
                    if (drillable)
                    {
                        drillable.OnDrill(fxSpawnPoint.position, helper, out GameObject gameObject2);
