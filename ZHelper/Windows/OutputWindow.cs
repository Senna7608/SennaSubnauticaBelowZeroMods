...
namespace ZHelper.Windows
{
    public partial class Zhelper
    {
        ...
        public void WindowLog(string message) => Write(message);

        public void WindowLog(string message, LogType type) => Write(message, type);

        public void WindowLog(string message, params object[] arg) => Write(message, arg);

        public void WindowLog(string message, LogType type, params object[] arg) => Write(message, type, arg);
    }
