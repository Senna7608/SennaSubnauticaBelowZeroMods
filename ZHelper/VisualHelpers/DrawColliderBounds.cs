    ...
    public class DrawColliderBounds : MonoBehaviour
    {
        ...
        public void Init()
        {
            ...
            switch (colliderInfo.ColliderType)
            {
                ...
                case ColliderType.MeshCollider:
                    gameObject.CreateLineContainers(ref lineContainers, ContainerType.ContinuousLine, 0.004f, Color.red, false);
                    break;
            }
        }
        ...
        public void Update()
        {
            ...
            switch (colliderInfo.ColliderType)
            {
                ...
                case ColliderType.MeshCollider:
                    gameObject.DrawMeshColliderBounds(ref lineContainers, (MeshCollider)collider);
                    break;
            }
        }        
    }
