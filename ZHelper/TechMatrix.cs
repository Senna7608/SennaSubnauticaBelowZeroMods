...
namespace ZHelper
{
    ...
    {
        List<TechTypeData>[] TechMatrix;

        public TechnologyMatrix()
        {
            CreateMatrix();
        ...
        {
            TechMatrix = new List<TechTypeData>[baseTechMatrix.Count];
            ...
            foreach (KeyValuePair<TechCategory, TechType[]> kvp in baseTechMatrix)
            {
                ...
                {
                    TechMatrix[i] = new List<TechTypeData>();
                    ...
                    for (int j = 0; j < kvp.Value.Length; j++)
                    {
                        ...
                        TechMatrix[i].Add(new TechTypeData(techType, name));
                    }
        ...
        {
            foreach (List<TechTypeData> item in TechMatrix)
            {
                item.Sort();
            }
        }
        ...
        private void SearchForModdedTechTypes()
        {
            ...
            {
                EquipmentType equipmentType = TechData.GetEquipmentType(kvp.Value);
                ...
                switch (equipmentType)
                {
                    ...
                    case (EquipmentType)100:
                        TechMatrix[(int)TechCategory.Upgrades].Add(new TechTypeData(kvp.Value, Language.main.Get(TechTypeExtensions.AsString(kvp.Value, false))));
                        break;
                }
            }
