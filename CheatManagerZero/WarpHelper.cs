...
namespace CheatManagerZero
{
    public partial class CheatManagerZero
    {
        protected readonly Dictionary<IntVector, string> WarpTargets_Internal = new Dictionary<IntVector, string>()
        {
            ...
            { new IntVector(-1621, 25, -737),    "Frozen Creature Cave"},            
            { new IntVector(550, -197, -1080),   "Research Base Omega"},
            { new IntVector(-254, 42, -770),     "Research Base Delta"},
            { new IntVector(-587, -27, 20),      "Emergency Supply Cache 1"},
            ...
            { new IntVector(-1195, 0, -1053),    "Glacial Basin Exit Pool"},
            ...
            { new IntVector(545, -619, -1092),   "Precursor Base (Lily Pads Deep)"},
