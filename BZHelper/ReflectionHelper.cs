...
#pragma warning disable CS1591 // Missing XML documentation
    ...
    {
        public static object StaticClassGetPrivateField(Type type, string fieldName)
        {
        ...
        public static object InvokePrivateMethodWithReturnValue<T>(this T instance, string methodName, BindingFlags bindingFlags = BindingFlags.Default, params object[] parms) where T : class
        {
            return instance.GetType().GetMethod(methodName, BindingFlags.Instance | BindingFlags.NonPublic | bindingFlags).Invoke(instance, parms);
        }
