...
namespace ModdedArmsHelperBZ.API.ArmHandlers
{
    ...
    public abstract class ArmHandler : MonoBehaviour
    {
        ...
        private Seatruck _seatruck = null;
        /// <summary>
        /// This property is returning the <see cref="Seatruck"/> component. If exists.
        /// </summary> 
        public Seatruck seatruck
        {
            get
            {
                if (_seatruck == null)
                {
                    _seatruck = GetComponentInParent<Seatruck>();
                }
        ...
        public GameObject lowerArm
        {
            get
            {
                if (_lowerArm == null)
                {
                    _lowerArm = UnityHelper.FindDeepChild(transform, "ModdedLowerArmContainer");
                }
