...
{
    internal class SlotExtenderZeroControl : MonoBehaviour
    {
        public SlotExtenderZeroControl Instance { get; private set; }
        ...
        private void Awake()
        {
            ...
            else if (gameObject.GetComponent<SeaTruckUpgrades>() != null)
            {
                ...
                SeatruckServices.Main.GetSeaTruckTelemetry(gameObject);
            }
        }
